...
export function SustainabilitySection() {
  return (
    <section
      ...
      id="sustainability"
    >
      <div className="flex w-full flex-col gap-6.5 rounded-4xl bg-[#B1D182]/50 dark:bg-primary-green p-6.5">
        <h1 className="font-bold text-5xl text-black dark:text-white">
          Alinhado aos objetivos de Desenvolvimento Sustentável da ONU
        </h1>

        <p className="text-black dark:text-white/70 text-xl">
        ...
        <article className="grid grid-cols-1 gap-3 md:grid-cols-3">
          <div className="flex flex-col gap-2 rounded-[18px] bg-white dark:bg-third-dark p-2 shadow-lg">
