	...
	return (
		...
		>
			<div className="flex flex-col gap-6">
				<h1 className="font-bold text-6xl text-primary-green-dark leading-20">
					Recicle de forma{" "}
					<span className="text-primary-green">inteligente</span> e{" "}
					<span className="text-primary-green">sustentável</span>.
				</h1>

				<p className="font-normal text-primary-green-dark text-xl">
				...
				<div className="flex gap-8 border-gray-300 border-t pt-8">
					<article>
						<div className="font-bold text-5xl text-primary-green">500+</div>
						<div className="text-primary-green-dark">Pontos de coleta</div>
					</article>

					<article>
						<div className="font-bold text-5xl text-primary-green">10k</div>
						<div className="text-primary-green-dark">Usuários ativos</div>
					</article>

					<article>
						<div className="font-bold text-5xl text-primary-green">50ton</div>
						<div className="text-primary-green-dark">Recicladas</div>
					</article>
				</div>
			</div>
