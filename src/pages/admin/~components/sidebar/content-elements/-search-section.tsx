...
export function SearchSection() {
	...
	return (
		<>
			<Button
				className="cursor-pointer text-muted-foreground group-data-[collapsible=icon]:w-8 group-data-[collapsible=icon]:pl-3"
				onClick={() => setOpen(true)}
				variant="outline"
			>
				<Search className="h-6 w-6 group-data-[collapsible=icon]:h-4 group-data-[collapsible=icon]:w-4" />
				<span className="ml-2 text-base group-data-[collapsible=icon]:sr-only">
					Pesquisar...
				</span>
