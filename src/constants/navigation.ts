...
export const searchNavigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    title: "Vendas",
    url: "/admin/sales",
    description: "Visão geral das vendas de reciclagem de sua cooperativa",
    group: "Principal",
    icon: dashboardData.primary.find((item) => item.title === "Vendas")?.icon,
    keywords: ["inicio", "home", "overview", "sales"],
  },
  {
    id: "statistics",
    title: "Estatísticas",
